...
Java_com_example_myapplication_MainActivity_transaction(JNIEnv *xenv, jobject xthiz, jbyteArray xtrd) {
...
Java_com_example_myapplication_MainActivity_initRng(JNIEnv *env, jclass) {
